...
class SecondStepFragment: Fragment(), View.OnClickListener {
    ...
    private val ballon by lazy { TextUtilities.getBallon(requireContext(),R.string.text_dashboard_help_infonavit, this) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            if ((checkBox.isChecked || checkBox2.isChecked)){
                ...
                parentFragmentManager.beginTransaction().addToBackStack(null).replace(R.id.content,ThirdStepFragment()).commit()
    ...
    override fun onClick(p0: View?) {
        p0?.let {v ->
            when (v.id) {
                ...
                R.id.textView37 ->{
                    dialogHelp.setData(R.string.title_dialog_help_information, R.string.subtitle_dialog_help_imss,R.drawable.imss,R.string.text2_information_dialog_calculator)
                    dialogHelp.show(parentFragmentManager,"imss")
                }
                R.id.textView40 -> {
                    dialogHelp.setData(R.string.title_dialog_help_information, R.string.subtitle_dialog_help_afore,R.drawable.ic_afore)
                    dialogHelp.show(parentFragmentManager,"afore")
                }
                R.id.textView42 -> {
                    dialogHelp.setData(R.string.title_dialog_help_information, R.string.subtitle_dialog_help_voluntary_afore,R.drawable.ic_afore_voluntary)
                    dialogHelp.show(parentFragmentManager,"voluntary_afore")
                }
                R.id.textView45 -> {
                    dialogHelp.setData(R.string.title_dialog_help_information, R.string.subtitle_dialog_help_infonavit,R.drawable.ic_infonavit_cal)
