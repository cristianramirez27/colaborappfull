...
public class EmploymentLettersMenuRecyclerAdapter extends RecyclerView.Adapter<EmploymentLettersMenuRecyclerAdapter.ViewHolder> {
    ...
    public EmploymentLettersMenuRecyclerAdapter(Context context, List<HomeMenuItem> menu, int spanCount) {
    ...
    private int getItemSize(int spanCount) {
        ...
        return (int ) (point.x / (spanCount*1.3));
    }
