...
public class HolidaysColaboratorsResponse extends HolidaysBaseResponse {
    private Data data;
    ...
    public class Response implements Serializable {
        ...
        private List<ColaboratorHoliday> empleados;
        private int clv_mensaje;
        private String des_mensaje;

        public List<ColaboratorHoliday> getEmpleados() {
            return empleados;
        }

        public void setEmpleados(List<ColaboratorHoliday> empleados) {
