...
class ThirdStepFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        seekBar.addOnChangeListener { _, value, _ ->
            age.text = format(getString(R.string.text_dashboard_calculation_age), value.toInt())
        }
    ...
    override fun onClick(p0: View?) {
        p0?.let { v ->
            when (v.id) {
                ...
                R.id.button8 -> dialogHelp.show(parentFragmentManager, "Information")
            }
        }
    }
    companion object {
