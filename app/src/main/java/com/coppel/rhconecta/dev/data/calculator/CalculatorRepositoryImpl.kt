...
class CalculatorRepositoryImpl(private val calculatorApiService: CalculatorApiService) :
    ...
    override suspend fun getInformationCalculator(
        ...
        return baseCommonService(
            calculatorApiService.getInformationCalculator(
                token, "2025-01-22T17:38:35.244Z",
                "-99.985171",
                "20.270460",
                "fs9999c7q86c33cdfd5f55", url, RequestCalculator(numberEmployer)
            ),
    ...
    override suspend fun getInformationWeek(
        ...
        return baseCommonService(
            calculatorApiService.getListedWeek(
                token, "2025-01-22T17:38:35.244Z",
                "-99.985171",
                "20.270460",
                "fs9999c7q86c33cdfd5f55", url, RequestListedWeek(nss, antiquity)
            ),
    ...
    override suspend fun scoreCalculator(
        ...
        return baseCommonService(
            calculatorApiService.scoreFlow(
                ...
                "-99.985171",
                "20.270460",
                "fs9999c7q86c33cdfd5f55", url,
                ScoreFlow(
                    scoreCalculator.score,
                    scoreCalculator.number,
                    scoreCalculator.like,
                    scoreCalculator.changed
                )
            ),
    ...
    override suspend fun getResultCalculation(
        ...
        return baseCommonService(
            calculatorApiService.getResultCalculation(token, "2025-01-22T17:38:35.244Z",
                "-99.985171",
                "20.270460",
                "fs9999c7q86c33cdfd5f55", url, RequestCalculation(
                    baseSalary = informationCalculator.imp_salariomensual.parseSaveDouble(),
                    dateBorn = informationCalculator.fechaNacimiento?.let {
                        informationCalculator.processDate(
                            it
                        )
                    } ?: "",
                    dateStart = informationCalculator.antiguedad?.let {
                        informationCalculator.processDate(
                            it
                        )
                    } ?: "",
