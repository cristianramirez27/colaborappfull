...
public class TicketView extends View {
    ...
    private void generateShadow() {
        if (isJellyBeanAndAbove() && !isInEditMode()) {
            ...
            mShadow = blur(getContext(), mShadow, mShadowBlurRadius);
        }
    }
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            dividerPositionPercent = typedArray.getFloat(R.styleable.TicketView_ticketDividerPositionPercent,0.5f);
            float elevation = 0f;
    ...
    private void setTicketBackgroundBeforeDivider(Canvas canvas) {
        ...
        float bottom = getHeight() - getPaddingBottom() - mShadowBlurRadius - (mShadowBlurRadius / 2);
        if (mOrientation == Orientation.HORIZONTAL) {
            mBackgroundBeforeDivider.setBounds((int) left, (int) top, (int) (right * dividerPositionPercent), (int) bottom);
        } else {
            mBackgroundBeforeDivider.setBounds((int) left, (int) top, (int) right, (int) (bottom* dividerPositionPercent));
        }
    ...
    private void setTicketBackgroundAfterDivider(Canvas canvas) {
        ...
        float bottom = getHeight() - getPaddingBottom() - mShadowBlurRadius - (mShadowBlurRadius / 2);
        if (mOrientation == Orientation.HORIZONTAL) {
            mBackgroundAfterDivider.setBounds((int) (right * dividerPositionPercent), (int) top, (int) right, (int) bottom);
        } else {
            mBackgroundAfterDivider.setBounds((int) left, (int) (bottom* dividerPositionPercent), (int) right, (int) bottom);
        }
