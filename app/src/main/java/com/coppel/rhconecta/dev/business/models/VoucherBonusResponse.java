...
public class VoucherBonusResponse extends CoppelGeneralParameterResponse {
    private Data data;
    ...
    public class Response {
        ...
        private DatosAguinaldo datosaguinaldo;
        private DatosAguinaldo2[] datosAguinaldo2;
        private String errorCode;
        private String userMessage;

        public DatosAguinaldo getDatosaguinaldo() {
            return datosaguinaldo;
        }

        public void setDatosaguinaldo(DatosAguinaldo datosaguinaldo) {
            this.datosaguinaldo = datosaguinaldo;
        }

        public DatosAguinaldo2[] getDatosAguinaldo2() {
            return datosAguinaldo2;
        }

        public void setDatosAguinaldo2(DatosAguinaldo2[] datosAguinaldo2) {
            this.datosAguinaldo2 = datosAguinaldo2;
        }
