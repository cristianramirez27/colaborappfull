...
public class AppConfig {
    ...
    public final static String ENDPOINT_SAVING_FUND = "ENDPOINT_SAVING_FUND";
    public final static String ENDPOINT_GAS = "ENDPOINT_GAS";
    public final static String ENDPOINT_UTILITIES = "ENDPOINT_UTILITIES";
    public final static String ENDPOINT_PENSION = "ENDPOINT_PENSION";
    public final static String ENDPOINT_BONUS = "ENDPOINT_BONUS";
     ...
     */
    public static void setEndpointConfig(FirebaseRemoteConfig mFirebaseRemoteConfig, CustomCallBack callBack) {
        ...
        try {
            ...
            //comprobantes
            String payrollVoucher = mFirebaseRemoteConfig.getString(ENDPOINT_NOMINA);
            String savingFund = mFirebaseRemoteConfig.getString(ENDPOINT_SAVING_FUND);
            String gas = mFirebaseRemoteConfig.getString(ENDPOINT_GAS);
            String pension = mFirebaseRemoteConfig.getString(ENDPOINT_PENSION);
            String utilities = mFirebaseRemoteConfig.getString(ENDPOINT_UTILITIES);
            String bonus = mFirebaseRemoteConfig.getString(ENDPOINT_BONUS);
            String vouchers = mFirebaseRemoteConfig.getString(ENDPOINT_VOUCHERS);
            ...
            //Comprobantes
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_NOMINA, payrollVoucher);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_SAVING_FUND, savingFund);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_GAS, gas);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_PENSION, pension);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_UTILITIES, utilities);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_BONUS, bonus);
            AppUtilities.saveStringInSharedPreferences(getApplicationContext(), ENDPOINT_VOUCHERS, vouchers);
