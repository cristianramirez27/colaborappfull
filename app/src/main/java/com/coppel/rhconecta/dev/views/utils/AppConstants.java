...
public class AppConstants {
    ...
    public static final String OPTION_ROOMS = "OPTION_ROOMS";
    ...
    public static final String ZENDESK_CHAT_ONLINE = "ZENDESK_CHAT_ONLINE";
    public static final String ZENDESK_CHAT_BOOT_NAME = "Coppel";
