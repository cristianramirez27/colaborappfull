...
public interface DatePickerController {
    ...
    void registerOnDateChangedListener(DatePickerHolidayDialog.OnDateChangedListener listener);

    @SuppressWarnings("unused")
    void unregisterOnDateChangedListener(DatePickerHolidayDialog.OnDateChangedListener listener);
