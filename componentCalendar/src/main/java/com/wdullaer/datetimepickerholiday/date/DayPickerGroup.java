...
public class DayPickerGroup extends ViewGroup
    ...
    private void init() {
        ...
        if (controller.getVersion() == DatePickerHolidayDialog.Version.VERSION_1) {
    ...
    private void updateButtonVisibility(int position) {
        final boolean isHorizontal = controller.getScrollOrientation() == DatePickerHolidayDialog.ScrollOrientation.HORIZONTAL;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final int topMargin = controller.getVersion() == DatePickerHolidayDialog.Version.VERSION_1
                ? 0
