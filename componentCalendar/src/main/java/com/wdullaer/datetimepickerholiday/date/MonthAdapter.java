...
import com.wdullaer.datetimepickerholiday.date.MonthAdapter.MonthViewHolder;
import com.wdullaer.datetimepickerholiday.date.MonthView.OnDayClickListener;
...
public abstract class MonthAdapter extends RecyclerView.Adapter<MonthViewHolder> implements OnDayClickListener {
    ...
    public MonthAdapter(DatePickerController controller,boolean enableThemeHoliday) {
    ...
    public MonthViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MonthView v = createMonthView(parent.getContext(),enableThemeHoliday);
        // Set up the new view
    ...
    public abstract MonthView createMonthView(Context context,boolean enableThemeHoliday);
