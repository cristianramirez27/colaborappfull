...
import com.wdullaer.datetimepickerholiday.GravitySnapHelper;
import com.wdullaer.datetimepickerholiday.Utils;
import com.wdullaer.datetimepickerholiday.date.DatePickerHolidayDialog.OnDateChangedListener;
...
public abstract class DayPickerView extends RecyclerView implements OnDateChangedListener {
    ...
    public DayPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        DatePickerHolidayDialog.ScrollOrientation scrollOrientation = Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ? DatePickerHolidayDialog.ScrollOrientation.VERTICAL
                : DatePickerHolidayDialog.ScrollOrientation.HORIZONTAL;
        init(context, scrollOrientation);
    }

    public DayPickerView(Context context, DatePickerController controller, boolean enableThemeHoliday) {
        super(context);
    ...
    public void init(Context context, DatePickerHolidayDialog.ScrollOrientation scrollOrientation) {
        int layoutOrientation = scrollOrientation == DatePickerHolidayDialog.ScrollOrientation.VERTICAL
     ...
     */
    protected void setUpRecyclerView(DatePickerHolidayDialog.ScrollOrientation scrollOrientation) {
        setVerticalScrollBarEnabled(false);
        setFadingEdgeLength(0);
        int gravity = scrollOrientation == DatePickerHolidayDialog.ScrollOrientation.VERTICAL
                ? Gravity.TOP
                : Gravity.START;
    ...
    protected void refreshAdapter() {
        if (mAdapter == null) {
            mAdapter = createMonthAdapter(mController,enableThemeHoliday);
        } else {
    ...
    public abstract MonthAdapter createMonthAdapter(DatePickerController controller, boolean enableThemeHoliday);
    ...
    public MonthView getMostVisibleMonth() {
        boolean verticalScroll = mController.getScrollOrientation() == DatePickerHolidayDialog.ScrollOrientation.VERTICAL;
