...
import com.wdullaer.datetimepickerholiday.date.MonthAdapter.CalendarDay;
...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller, boolean enableThemeHoliday) {
        ...
        DAY_SELECTED_CIRCLE_SIZE = mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1
        ...
        if (mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1) {
        ...
        mEdgePadding = mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1
                ? 0
    ...
    public int getMonthHeight() {
        int scaleFactor = mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1 ? 2 : 3;
    ...
    protected int getMonthHeaderSize() {
        return mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1
                ? MONTH_HEADER_SIZE
    ...
    protected void drawMonthTitle(Canvas canvas) {
        int x = mWidth / 2;
        int y = mController.getVersion() == DatePickerHolidayDialog.Version.VERSION_1
