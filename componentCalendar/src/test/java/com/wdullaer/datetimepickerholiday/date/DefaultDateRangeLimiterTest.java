...
public class DefaultDateRangeLimiterTest {
    final private DatePickerController controller = new DatePickerController() {
        ...
        @Override
        public void registerOnDateChangedListener(DatePickerHolidayDialog.OnDateChangedListener listener) {}

        @Override
        public void unregisterOnDateChangedListener(DatePickerHolidayDialog.OnDateChangedListener listener) {}
        ...
        @Override
        public DatePickerHolidayDialog.Version getVersion() {
            return DatePickerHolidayDialog.Version.VERSION_2;
        }

        @Override
        public DatePickerHolidayDialog.ScrollOrientation getScrollOrientation() {
            return DatePickerHolidayDialog.ScrollOrientation.HORIZONTAL;
        }
    };
