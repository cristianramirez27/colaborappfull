    ...
    private GridView getDaysNames() {
        ...
        daysName.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                day.setText(getNameMonthFormatted(days[position]));
                //if (typedArray != null) {
            ...
            private String[] getWeekDayNames() {
                ...
                //String[] names = new String[]{"Dom","Lun","Mar","Mié","Jue","Vie","Sáb"};
        ...
        //if (typedArray != null)
            daysName.setBackgroundColor(Color.parseColor("#ededed"));
        return daysName;
    }

    private String getNameMonthFormatted(String month){
